...
public class Caja {
	...
	private ArrayList<BonificacionDescuentoCupon> cupones;
	...
	public Caja(int numero) {
		...
		cupones = new ArrayList<BonificacionDescuentoCupon>();
...
//		if(this.compraActual.getCuponesGenerados().size()>0){
//			this.cupones.addAll(this.compraActual.getCuponesGenerados());
//		}
	...
	public ArrayList<BonificacionDescuentoCupon> getCupones(){
		return this.cupones;
	}
